...
*/
<template>
  <div class="my-enterprise-resources">
    <el-form
        size="small"
        ref="form"
        :rules="rules"
    ...
    <div class="split-line">
      <div class="split-line-left">
        <el-button icon="el-icon-plus" size="small" type="primary"
                   @click.stop="$router.push('/my-enterprise-resources-add')">新建资源
        </el-button>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      form: {
        ...
        customerType: '',
        shared: null,
        creatorId: this.$store.state.currentUser.userId,
        date: []
      },
      rules: {
  ...
  methods: {
    ...
    handleView(_index, _row) {
      this.$router.push('/my-enterprise-resources-view/' + _row.id)
    },
    handleEdit(_index, _row) {
      this.$router.push('/my-enterprise-resources-edit/' + _row.id)
    },
