...
*/
<template>
  <div class="education-promotion-edit">
    ...
    handleSubmit() {
      this.$refs.form.validate(async valid => {
        if (valid) {
          ...
          try {
            const res = await this.$http.put('/education-promotion/update', this.form)
            if (res && res.status) {
