...
*/
<template>
  <div class="class-three-personnel-order-detail">
    <el-dialog
        append-to-body
        width="80%" title="三类人员订单详情" :visible.sync="visible" :before-close="()=>$emit('closeDialog')">
...
<script>
export default {
  name: 'ClassThreePersonnelOrderDetail',
  components: {},
  props: {
    visible: {
      type: Boolean,
