...
*/
<template>
  <div class="title-evaluation-edit">
          ...
          <div class="dialog-content" style="margin-right: 10px">
            <el-form
              ...
              <el-row :gutter="20">
                <el-col :span="12">
                  <el-form-item label="姓名" prop="fullName">
                    <el-input show-word-limit maxlength="10" clearable placeholder="请输入姓名" v-model.trim="innerForm.fullName"/>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
              ...
              <el-row :gutter="20">
                <el-col :span="12">
                  <el-form-item label="身份证" prop="identityCard">
                    <el-input show-word-limit maxlength="18" clearable placeholder="请输入身份证" v-model.trim="innerForm.identityCard"/>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
              ...
              <el-row :gutter="20">
                <el-col :span="12">
                  <el-form-item label="毕业专业" prop="graduationMajor">
                    <el-input show-word-limit maxlength="15" clearable placeholder="请输入毕业专业" v-model.trim="innerForm.graduationMajor"/>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="评审专业" prop="evaluationMajor">
                    <el-input show-word-limit maxlength="15" clearable placeholder="请输入评审专业" v-model.trim="innerForm.evaluationMajor"/>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row :gutter="20">
              ...
              <el-row :gutter="20">
                <el-col :span="12">
                  <el-form-item label="联系电话" prop="telephoneNumber">
                    <el-input show-word-limit maxlength="11" clearable placeholder="请输入联系电话" v-model="innerForm.telephoneNumber"/>
                  </el-form-item>
                </el-col>
              </el-row>
              <ImagesUpload2
...
export default {
  ...
  data() {
    ...
    return {
      ...
      innerForm: {
        fullName: '司马玉龙',
        sex: '男',
        identityCard: '452123199809222633',
        education: '博士',
        graduationMajor: '网络工程',
        evaluationMajor: '网络工程',
        evaluationFee: null,
        titleEvaluation: '博士',
        certificateNature: '公有',
        appraisalWay: '鉴定',
        agencyAmount: 20,
        telephoneNumber: '4141441',
        listImages: []
      },
      innerRules: {
        fullName: [
  ...
  methods: {
    ...
    async downloadFileTemplate() {
      ...
      a.href = "/file-template/职称评审人员.xlsx"
      a.download = "职称评审人员.xlsx"
    ...
    handleSubmit() {
      this.$refs.form.validate(async valid => {
        if (valid) {
          ...
          try {
            const res = await this.$http.put('/title-evaluation/update', this.form)
            if (res && res.status) {
        ...
        if (valid) {
          ...
          this.form.listAssessors.forEach(item => {
            item.listImages.forEach(img => {
              img.namespace = 'title-evaluation'
              img.type = 'assessor'
            })
          })
          this.$refs.innerForms.resetFields()
     ...
     */
    getDetailById(_id) {
      this.$http.get('/title-evaluation/detail/' + _id).then(res => {
