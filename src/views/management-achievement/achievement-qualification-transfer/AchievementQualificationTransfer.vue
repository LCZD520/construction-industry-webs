...
<template>
  <div class="achievement-qualification-transfer">
    <el-form
        ...
        inline
        :model="form">
      <el-form-item label="收购意向企业" label-width="120px">
        <el-input size="small" v-model="form.newPassword" placeholder="请输入收购意向企业">
        </el-input>
      </el-form-item>
      <el-form-item label="转让意向企业" label-width="120px">
        <el-input size="small" v-model="form.newPassword" placeholder="请输入转让意向企业">
        </el-input>
      </el-form-item>
      <el-form-item label="资质订单编号" label-width="120px">
        <el-input size="small" v-model="form.newPassword" placeholder="请输入资质订单编号">
        </el-input>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleView(_index,_row){
      ...
      this.$router.push('/achievement-qualification-transfer-view')
    },
