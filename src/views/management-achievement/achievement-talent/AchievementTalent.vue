...
<template>
  <div class="achievement-talent">
    <el-form
      ...
      <el-form-item label="人才名称" label-width="120px">
      ...
      <el-form-item label="人才录入人" label-width="120px">
        <el-select size="small" v-model="form.newPassword" placeholder="请选择人才录入人">
          <el-option
              v-for="item in options"
              :key="item.value"
              :label="item.label"
      ...
      <el-form-item label="企业录入人" label-width="120px">
        <el-select size="small" v-model="form.newPassword" placeholder="请选择企业录入人">
          <el-option
              v-for="item in options"
              :key="item.value"
              :label="item.label"
...
export default {
  ...
  methods: {
    ...
    handleView(_index,_row){
      ...
      this.$router.push('/achievement-talent-view')
    },
