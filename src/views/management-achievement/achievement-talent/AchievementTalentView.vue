...
*/
<template>
  <div class="achievement-talent-view">
    <el-form label-position="right" label-width="130px">
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="人才其他补贴费用">
            <el-input disabled size="small" v-model="form.name"/>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="人才业绩">
            <el-input disabled size="small" v-model="form.name"/>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="企业业绩">
            <el-input disabled size="small" v-model="form.name"/>
          </el-form-item>
        </el-col>
      </el-row>
