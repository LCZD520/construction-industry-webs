...
*/
<template>
  <div class="achievement-title-evaluation-view">
...
<script>
export default {
  name: 'AchievementTitleEvaluationView',
  components: {},
  data() {
    return {
      form: {
...
.achievement-title-evaluation-view {
  margin: 0 100px;
}
