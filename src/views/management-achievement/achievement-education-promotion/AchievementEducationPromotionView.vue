...
*/
<template>
  <div class="achievement-education-promotion-view">
...
<script>
export default {
  name: 'AchievementEducationPromotionView',
  components: {},
  data() {
    return {
      form: {
...
.achievement-education-promotion-view {
  margin: 0 100px;
}
