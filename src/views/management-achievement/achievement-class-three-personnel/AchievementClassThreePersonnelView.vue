...
*/
<template>
  <div class="achievement-class-three-personnel-view">
...
<script>
export default {
  name: 'AchievementClassThreePersonnelView',
  components: {},
  data() {
    return {
      form: {
...
.achievement-class-three-personnel-view {
  margin: 0 100px;
}
