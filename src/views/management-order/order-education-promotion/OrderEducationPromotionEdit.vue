...
*/
<template>
  <div class="order-education-promotion-edit">
...
<script>
export default {
  name: 'OrderClassThreePersonnelEdit',
  components: {},
  data() {
    return {
      list: [],
  ...
  methods: {
    ...
    async handleSubmit() {
      ...
      try {
        const res = await this.$http.put('/education-promotion-order/update-assessor/'
...
.order-education-promotion-edit {
  margin: 0 50px;
}
</style>
