    ...
    <el-dialog
      ...
      <el-form
        ...
        <el-form-item label="开户行" prop="openBank">
          <el-input clearable v-model.trim="form.openBank" placeholder="请选择开户行">
          </el-input>
        </el-form-item>
        <el-form-item label="户名" prop="accountName">
          <el-input clearable v-model.trim="form.accountName" placeholder="请选择银行卡号">
          </el-input>
        </el-form-item>
        <el-form-item label="银行卡号" prop="bankCardNo">
          <el-input clearable v-model.trim="form.bankCardNo" placeholder="请选择银行卡号">
          </el-input>
        </el-form-item>
      </el-form>
