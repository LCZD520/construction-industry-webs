...
*/
<template>
  <div class="transfer-class-three-personnel">
    <el-form
        ref="formData"
        inline
        :model="form">
      ...
      <el-form-item label="申请人" label-width="120px">
        <el-select size="small" v-model="form.oldPassword" placeholder="请选择申请人人">
          <el-option
...
<script>
export default {
  name: 'TransferClassThreePersonnel',
  components: {},
  data() {
    return {
      columns: [
  ...
  methods: {
    ...
    handleView(_index,_row){
      ...
      this.$router.push('/transfer-class-three-personnel-view')
    },
  }
}
</script>
