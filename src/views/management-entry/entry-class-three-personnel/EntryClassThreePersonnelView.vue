...
*/
<template>
  <div class="entry-class-three-personnel-view">
    <el-form label-position="right" label-width="120px">
      ...
      <br>
      <el-divider content-position="left">三类人员图片</el-divider>
      <el-card>
        <div slot="header">
          <span>合同</span>
...
<script>
export default {
  name: 'EntryClassThreePersonnelView',
  components: {},
  data() {
    return {
      form: {
...
.entry-class-three-personnel-view {
  margin: 0 100px;
