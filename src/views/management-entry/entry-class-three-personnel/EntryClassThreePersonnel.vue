...
*/
<template>
  <div class="entry-class-three-personnel">
    <el-form
        ref="formData"
        inline
        :model="form">
      ...
      <el-form-item label="录入人" label-width="120px">
        <el-select size="small" v-model="form.oldPassword" placeholder="请选择三类人员录入人">
          <el-option
              v-for="item in options"
              :key="item.value"
              :label="item.label"
...
export default {
  ...
  methods: {
    ...
    handleView(_index,_row){
      ...
      this.$router.push('/entry-class-three-personnel-view')
    }
  }
}
</script>
