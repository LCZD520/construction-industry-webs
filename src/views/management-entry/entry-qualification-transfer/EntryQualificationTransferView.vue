...
*/
<template>
  <div class="entry-qualification-transfer-view">
    <el-form label-position="right" label-width="120px">
      ...
      <br>
      <el-divider content-position="left">资质转让图片</el-divider>
      <el-card>
        <div slot="header">
          <span>合同</span>
...
<script>
export default {
  name: 'EntryQualificationTransferView',
  components: {},
  data() {
    return {
      form: {
...
.entry-qualification-transfer-view {
  margin: 0 100px;
