...
*/
<template>
  <div class="entry-education-promotion-view">
    <el-form label-position="right" label-width="120px">
      ...
      <br>
      <el-divider content-position="left">学历提升图片</el-divider>
      <el-card>
        <div slot="header">
          <span>合同</span>
...
<script>
export default {
  name: 'EntryEducationPromotionView',
  components: {},
  data() {
    return {
      form: {
...
.entry-education-promotion-view {
  margin: 0 100px;
